    ...
    <Layout title="Lessons">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="mb-6">
          <TabsTrigger value="lessons-list">Lessons List</TabsTrigger>
          <TabsTrigger value="lesson-view" disabled={!selectedLesson}>
            Lesson View
          </TabsTrigger>
          {isTeacherOrDirector && (
            <TabsTrigger value="lesson-resources">Resources</TabsTrigger>
          )}
        </TabsList>
